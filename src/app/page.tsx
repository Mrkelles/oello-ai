...
export default function Home() {
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <section className="py-24 px-4 bg-white/40 text-center">
      ...
      <section className="py-24 px-4 bg-primary text-primary-foreground text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-8 relative z-10">
          <h2 className="text-4xl md:text-6xl font-headline font-bold">Ready for Your <span className="text-accent italic">Best Skin Ever?</span></h2>
          <p className="text-xl text-primary-foreground/80">Join the thousands of people who have made Saam their daily essential. Get 15% Off Your First Order today!</p>
          <div className="pt-4">
